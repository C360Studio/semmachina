...
var worldFactSubjectKinds = map[Predicate][]EntityKind{
	...
	CaseMemberVictim:                {EntityKindCase},
	CaseLifecyclePhase:              {EntityKindCase},
	CaseLifecycleEventID:            {EntityKindCase},
	CaseLifecycleEventKindPredicate: {EntityKindCase},
	CaseLifecycleFromPhase:          {EntityKindCase},
	CaseLifecycleToPhase:            {EntityKindCase},
	CaseTransitionSource:            {EntityKindCase},
	CaseTransitionAt:                {EntityKindCase},
