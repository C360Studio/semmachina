...
Platform adapter. Your first action is to read `.agents/skills/orchestration-check/SKILL.md` fully and
follow it as the canonical instruction for this skill, applied to: $ARGUMENTS
